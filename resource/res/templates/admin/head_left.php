    ...
    <div class="navbar-fixed">
        <nav>
            <div class="nav-wrapper nav-green">
                <div class="left pad-left-20"><a class="cursor" id="trigger-sidebar"><i class="material-icons"
                            id="menu-icon" title="Ẩn/Hiện bảng điều hướng">menu</i></a></div>
                <a href="index.php?action=show_dashboard" class="brand-logo right cursor"><i
        ...
        <div class="card reset-margin">
            <div class="card-image">
                ...
                <span class="card-title" style="padding: 20px; "><i id="user-name"><?=$info['name']?></i>
                    <a href="index.php?action=show_profiles" class="cursor blue-text text-darken-2"><i
                            class="material-icons">create</i></a>
                </span>
            </div>
        </div>
        <ul class="collapsible reset-margin" data-collapsible="accordion">
            <a href="index.php?action=show_dashboard" class="collapsible-header font-color"><i
                    class="material-icons">home</i>Trang Tổng Quan</a>
            <li class="">
                <div class="collapsible-header" id="menu"><i class="material-icons hide"
                        id="menu-arrow-down">arrow_drop_down</i>
                    <i class="material-icons" id="menu-arrow-up">arrow_drop_up</i>Menu
                </div>
