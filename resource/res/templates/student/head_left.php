...
<body class="body-login  overflow scrollbar">
    ...
    <div class="sidebar-left sidebar-show menu-sidebar scrollbar" id="sidebar-left">
        ...
        <ul class="collapsible reset-margin" data-collapsible="accordion">
            <a href="index.php?action=show_dashboard" class="collapsible-header font-color cursor"><i
                    class="material-icons">library_books</i>Làm Bài Tập</a>
            <a href="index.php?action=show_chat" class="collapsible-header font-color cursor"><i
